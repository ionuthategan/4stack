    ...
    <div class="row">
        <div class="content_div">
            <ul>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="link_content">
                                <span class="link_name">John Snow</span>
                                <br>
                                <small class="link_second">driver at BIO Winterfell</small>
                            </td>
                            <td>
                            </td>
                        </tr>
                ...
                <li class="">
                    <a href="employee_timeline.php" class="page_link">
                        <table>
                            <tr>
                ...
                <li class="">
                    <a href="leave_requests.php" class="page_link">
                        <table>
                            <tr>
