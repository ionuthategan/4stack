        ...
        <div class="content_div">
            <ul>
                <li class="w page_head">
                    <table>
                        <tr>
                            <td class="link_image" rowspan="4">
                                <img src="img/pic-manager.png" alt="">
                            </td>
                        </tr>
                        <tr>
                ...
                <li class="">
                    <a href="company_profile.php" class="page_link" id="company_link">
                        <table>
                            <tr>
                                <td class="link_icon" rowspan="5" style="background:#4D4D4D;">
                    ...
                    <div class="w" style="height: 20px;padding: 10px 0px;position:relative;">
                        <hr class="link_hr">
                    </div>
                </li>
                <li class="">
                    <a href="checked_in.php" class="page_link">
                        <table>
                            <tr>
                                <td class="link_icon" rowspan="5" style="background:#CB3B4D;">
                                    <i class="fa fa-sign-in  fa-4x" aria-hidden="true"></i>
                                </td>
                            </tr>
                            <tr>
                                <td class="link_content">
                                    <span class="link_name">Check in/out</span>
                                    <br>
                                    <small class="link_second">check in/out work</small>
                                </td>
                                <td class="fa_right"><i class="fa fa-angle-right fa-3x" aria-hidden="true"></i>
                                </td>
                            </tr>
                ...
                <li class="">
                    <a href="employee_timeline.php" class="page_link" id="timeline">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td class="link_content">
                                    ...
                                    <br>
                                    <small class="link_second">view your history</small>
                                </td>
                                <td class="fa_right"><i class="fa fa-angle-right fa-3x" aria-hidden="true"></i>
                                </td>
                            </tr>
                ...
                <li class="">
                    <a href="leave_requests.php" class="page_link" id="leave_requests">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td class="link_content">
                                    ...
                                    <br>
                                    <small class="link_second">view your leave requests</small>
                                </td>
                                <td class="fa_right"><i class="fa fa-angle-right fa-3x" aria-hidden="true"></i>
                                </td>
                            </tr>
                ...
                <li class="">
                    <a href="income.php" class="page_link">
                        <table>
                            <tr>
                ...
                <li class="">
                    <a href="settings.php" class="page_link">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td class="link_content">
                                    ...
                                    <br>
                                    <small class="link_second">change your prfile settings</small>
                                </td>
                                <td class="fa_right"><i class="fa fa-angle-right fa-3x" aria-hidden="true"></i>
                                </td>
                            </tr>
